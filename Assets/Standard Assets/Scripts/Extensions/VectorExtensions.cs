...
namespace Extensions
{
	public static class VectorExtensions
	{
		...
		public static bool IsFacingAngleWithinAngleRange (this Vector2Int v, AngleRange angleRange, bool equalAnglesCountsAsIn = false)
		{
			return new Angle(v.ToVec2().GetFacingAngle()).IsWithinAngleRange(angleRange, equalAnglesCountsAsIn);
		}

		public static Vector2Int Snap (this Vector2Int v, Angle snap, bool searchClockwise = false)
		{
