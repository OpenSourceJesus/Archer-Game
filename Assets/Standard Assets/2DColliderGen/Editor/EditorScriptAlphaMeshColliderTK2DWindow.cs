...
public class EditorScriptAlphaMeshColliderTK2DWindow : EditorWindow {
	...
	//-------------------------------------------------------------------------
	[MenuItem("Window/2D ColliderGen/2D Toolkit Window", true)]
	static bool ValidateGenerateColliderVerticesMenuEntry() {
		// no special selection criteria needed.
		return true;
    }
	//-------------------------------------------------------------------------
	[MenuItem("Window/2D ColliderGen/2D Toolkit Window", false, 1025)]
	static void GenerateColliderVerticesMenuEntry() {
        ...
        window.titleContent = new GUIContent("ColliderGen TK2D");
#else
	...
	protected void InitWithPreferencesValues() {
        ...
        this.mAlgorithmHelper.RegionIndependentParams.AlphaOpaqueThreshold = AlphaMeshColliderPreferences.Instance.DefaultAlphaOpaqueThreshold;
